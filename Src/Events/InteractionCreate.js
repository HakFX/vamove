...
const { returnDataKey, validatePlayer } = require('../Api/mainAPI.js');

client.modals = new Map();
client.buttons = new Map();

const universeID = await returnDataKey('YOUR_DATABASE_SAVED_UNIVERSE_ID'); // YOUR DATABASE_SAVED_UNIVERSE_ID aka place ID
